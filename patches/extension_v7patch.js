...
// ConnectManager class to manage connections for events to trigger BarEnhanced updatestyle
...
export default class BarEnhanced extends Extension {
    ...
    // this allow theming QSAP panels when QSAP is enabled after Bar Enhanced
