 ...
 * author: MrVanguardia (Original creator: neuromorph)
 */
...
export default class BarEnhancedPreferences extends ExtensionPreferences {
    ...
    fillPreferencesWindow(window) {
        let prefs = new BarEnhancedPrefs();
        prefs.fillBarEnhancedPrefs(window, this);
    }
...
class BarEnhancedPrefs {
    ...
    saveStylesheet() {
        ...
        */
        ...
        stylesheet += `
            ...
            #panel.barEnhanced .button-container {
                ${btnContainerStyle}
            }

            #panel.barEnhanced .panel-button {
                ${btnStyle}
            }

            #panel.barEnhanced .panel-button:hover, #panel.barEnhanced .panel-button:focus, #panel.barEnhanced .panel-button:active, #panel.barEnhanced .panel-button:checked {
                ${btnHoverStyle}
            }

            #panel.barEnhanced .panel-button:hover.clock-display .clock {
                background-color: transparent;
                box-shadow: none;
            }
            
            #panel.barEnhanced .panel-button:active.clock-display .clock, #panel.barEnhanced .panel-button:overview.clock-display .clock, 
            #panel.barEnhanced .panel-button:focus.clock-display .clock, #panel.barEnhanced .panel-button:checked.clock-display .clock {
                background-color: transparent;
                box-shadow: none;
            }

            #panel.barEnhanced .workspace-dot {
                ${dotStyle}
            }

            #panel.barEnhanced .trilands:left {
                ${triLeftStyle}
            }
            #panel.barEnhanced .trilands:right {
                ${triRightStyle}
            }
            #panel.barEnhanced .trilands:both {
                ${triBothStyle}
            }
            #panel.barEnhanced .trilands:none {
                ${triNoneStyle}
            }
            #panel.barEnhanced .trilands:none:hover, #panel.barEnhanced .trilands:none:focus, #panel.barEnhanced .trilands:none:active, #panel.barEnhanced .trilands:none:checked {
        ...
        let stylepath = this.barEnhanced.path + '/stylesheet.css';
    ...
    fillBarEnhancedPrefs(window, barEnhanced) {

        window.set_title(_("Bar Enhanced 🍹"));
        ...
        this.barEnhanced = barEnhanced;
        // Get the settings object
        this._settings = barEnhanced.getSettings();
        ...
        const aboutImage = new Gtk.Image({
            file: this.barEnhanced.path + "/media/barEnhanced.jpg",
            vexpand: false,
            hexpand: false,
            pixel_size: 100,
            margin_bottom: 15,
        ...
        let titleLabel = new Gtk.Label({
            label: `<span size="large"><b>Top Bar Customization</b></span>\n\n<span size="small" underline="none">${_('Version:')} ${this.barEnhanced.metadata.version}  |  <a href="${this.barEnhanced.metadata.url}">Home</a>  |  © <a href="https://github.com/mrvanguardia">MrVanguardia</a> (Original by <a href="https://extensions.gnome.org/accounts/profile/neuromorph">neuromorph</a>)  |  <a href="https://www.buymeacoffee.com/neuromorph"> ☕      </a></span>`,
