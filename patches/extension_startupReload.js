...
export default class BarEnhanced extends Extension {
                ...
                if(btn.child?.constructor.name === 'ActivitiesButton') {
                    ...
                    for(const indicator of list) { 
                        ...
                        if(dot?.remove_style_class_name)
                            dot.remove_style_class_name('barEnhanced');
                    }
                }   
                
                // Remove style class from Button and Container
                btn.remove_style_class_name('barEnhanced');
                btn.child?.remove_style_class_name('barEnhanced');
            }
        }
    ...
    unloadStylesheet() {
        ...
        try { 
            ...
            console.log('BarEnhanced: Error unloading stylesheet: ');
            throw e;
        }
    }
    ...
    loadStylesheet() {
        ...
        try {
            ...
            console.log('BarEnhanced: Error loading stylesheet: ');
            throw e;
        }        
    }
        ...
        for(const box of panelBoxes) {
            ...
            for(const btn of box) {
                ...
                if(btn.child instanceof PanelMenu.Button || btn.child instanceof PanelMenu.ButtonBox) {
                    btn.child.add_style_class_name('barEnhanced');
                    ...
                    if(btn.child.visible) { 
                        ...
                        btn.add_style_class_name('barEnhanced');
                    ...
                    if(btn.child.constructor.name === 'ActivitiesButton') {
                        ...
                        for(const indicator of list) { 
                            ...
                            if(dot?.add_style_class_name) {
                                dot.add_style_class_name('barEnhanced');
                                if(candybar)
