...
function getStylesheet(obar, Me) {
    ...
    let neonIntensity = obar._settings.get_double('neon-intensity');
    ...
    // Dynamic non-destructive System Accent Color Synchronization
        ...
        try {
            ...
            if (interfaceSettings.settings_schema.has_key('accent-color')) {
                ...
                const accentRGBs = {
                    ...
                    'green': ['0.180', '0.761', '0.494'],
                    'yellow': ['0.961', '0.761', '0.067'],
                    'orange': ['0.902', '0.380', '0.000'],
                    'red': ['0.878', '0.106', '0.141'],
                    'pink': ['0.878', '0.353', '0.541'],
                    'purple': ['0.569', '0.255', '0.675'],
                    'slate': ['0.435', '0.471', '0.506']
                };
                let rgbRatio = accentRGBs[systemAccent] || accentRGBs['blue'];
                borderColor = rgbRatio;
                msColor = rgbRatio;
            }
        } catch (e) {
            // fallback gracefully
    ...
    if (neon) {
        ...
        neonStyle =
            ` box-shadow: 0px 0px 4px ${spread}px rgba(${bred},${bgreen},${bblue},${neonIntensity.toFixed(2)}); `;
    ...
    // Placeholder for .barEnhanced class
    let barEnhancedClass = '.barEnhanced';

    // Create Stylesheet string to write to file
    let stylesheet = `
    /* BarEnhanced stylesheet.css
    * This file is autogenerated. Do Not Edit.
    *
    * SPDX-License-Identifier: GPL-2.0-or-later
    * author: MrVanguardia
    */
    ...
    stylesheet += `
        ...
        #panelBox${barEnhancedClass} {
           background-color: rgba(${boxred},${boxgreen},${boxblue},${boxalpha}) !important;
        }

        #panel${barEnhancedClass} #panelLeft {
            margin-left: ${vPad}px;
        }
        #panel${barEnhancedClass} #panelRight {
            margin-right: ${vPad}px;
        }

        #panel${barEnhancedClass} {
            ${panelStyle}
            ${unlockStyle}
            transition-duration: 100ms;
        }

        #panel${barEnhancedClass} StLabel {
            ${panelLabelStyle}
        }

        #panel${barEnhancedClass}:windowmax {
            border-radius: 0px !important;
        ...
        #panel${barEnhancedClass} .button-container {
            ${btnContainerStyle}
        }
        #panel${barEnhancedClass}:windowmax .button-container {
            margin: ${marginWMax}px 0px;
            padding: ${vPad}px ${hPad}px;
        }

        #panel${barEnhancedClass} .panel-button {
            box-shadow: none;
            ${btnStyle}
        ...
        #panel${barEnhancedClass}:windowmax .panel-button {
        ...
        #panel${barEnhancedClass}:overview, #panel${barEnhancedClass}:overview .panel-button {
            ${setOverview ? '' : overviewStyle}
        }

        #panel${barEnhancedClass}:overview:windowmax {
            ${overviewStyle}
        }


        #panel${barEnhancedClass} .panel-button:hover, #panel${barEnhancedClass} .panel-button:focus,
        #panel${barEnhancedClass} .panel-button:active, #panel${barEnhancedClass} .panel-button:checked {
            ${btnHoverStyle}
            color: rgba(${hfgred},${hfggreen},${hfgblue},${fgalpha}) !important;
            ${unlockHoverStyle}
            transition-duration: 150ms;
        }
        #panel${barEnhancedClass}:windowmax .panel-button:hover, #panel${barEnhancedClass}:windowmax .panel-button:focus,
        #panel${barEnhancedClass}:windowmax .panel-button:active, #panel${barEnhancedClass}:windowmax .panel-button:checked {
            ${wmaxColorStyle}
            ${wmaxHoverStyle}
        }
        #panel${barEnhancedClass}:overview .panel-button:hover, #panel${barEnhancedClass}:overview .panel-button:focus,
        #panel${barEnhancedClass}:overview .panel-button:checked, #panel${barEnhancedClass}:overview .panel-button:active,
        #panel${barEnhancedClass}:overview .panel-button:overview {
            ${btnHoverStyle}
            ${setOverview ? '' : barHFgOverview}
            ${setOverview ? '' : barHBgOverview}
        }

        #panel${barEnhancedClass} .panel-button.clock-display .clock {
            color: rgba(${fgred},${fggreen},${fgblue},${fgalpha}) !important;
            border: none; padding: 0px 6px; text-align: center;
            height: ${height}px !important;
        }
        #panel${barEnhancedClass}:windowmax .panel-button.clock-display .clock {
            ${wmaxColorStyle}
        }
        #panel${barEnhancedClass}:overview .panel-button.clock-display .clock {
            ${barFgOverview}
        }

        #panel${barEnhancedClass} .panel-button:hover.clock-display .clock, #panel${barEnhancedClass} .panel-button:focus.clock-display .clock,
        #panel${barEnhancedClass} .panel-button:active.clock-display .clock, #panel${barEnhancedClass} .panel-button:checked.clock-display .clock {
            color: rgba(${hfgred},${hfggreen},${hfgblue},1.0) !important;
        }
        #panel${barEnhancedClass}:windowmax .panel-button:hover.clock-display .clock, #panel${barEnhancedClass}:windowmax .panel-button:focus.clock-display .clock,
        #panel${barEnhancedClass}:windowmax .panel-button:active.clock-display .clock, #panel${barEnhancedClass}:windowmax .panel-button:checked.clock-display .clock {
            ${wmaxColorStyle}
        }
        #panel${barEnhancedClass}:overview .panel-button:hover.clock-display .clock, #panel${barEnhancedClass}:overview .panel-button:focus.clock-display .clock,
        #panel${barEnhancedClass}:overview .panel-button:active.clock-display .clock, #panel${barEnhancedClass}:overview .panel-button:checked.clock-display .clock {
            ${barHFgOverview}
        }

        #panel${barEnhancedClass} .panel-button.clock-display .clock, #panel${barEnhancedClass} .panel-button:hover.clock-display .clock,
        #panel${barEnhancedClass} .panel-button:active.clock-display .clock, #panel${barEnhancedClass} .panel-button:overview.clock-display .clock,
        #panel${barEnhancedClass} .panel-button:focus.clock-display .clock, #panel${barEnhancedClass} .panel-button:checked.clock-display .clock {
            background-color: transparent !important;
            box-shadow: none !important;
        }

        #panel${barEnhancedClass} .panel-button.screen-recording-indicator, #panel${barEnhancedClass}:windowmax .panel-button.screen-recording-indicator {
            transition-duration: 150ms;
            font-weight: bold;
        ...
        #panel${barEnhancedClass} .panel-button.screen-sharing-indicator, #panel${barEnhancedClass}:windowmax .panel-button.screen-sharing-indicator,
        #panel${barEnhancedClass} .screencast-indicator, #panel${barEnhancedClass}:windowmax .screencast-indicator,
        #panel${barEnhancedClass} .remote-access-indicator, #panel${barEnhancedClass}:windowmax .remote-access-indicator {
            transition-duration: 150ms;
            font-weight: bold;
        ...
        #panel${barEnhancedClass} .workspace-dot {
            ${dotStyle}
            transition-duration: 200ms;
        }
        #panel${barEnhancedClass}:overview .workspace-dot {
            ${dotOverview}
        }
        #panel${barEnhancedClass}:windowmax .workspace-dot {
            ${wmaxDotStyle}
        }


        #panel${barEnhancedClass}.trilands .panel-button {
            ${triMidStyle}
        }
        #panel${barEnhancedClass}.trilands .button-container:first-child .panel-button {
            ${triLeftStyle}
        }
        #panel${barEnhancedClass}.trilands .button-container:last-child .panel-button {
            ${triRightStyle}
        }
        #panel${barEnhancedClass}.trilands .button-container:first-child:last-child .panel-button {
            ${triBothStyle}
        }

        #panel${barEnhancedClass}.trilands:overview .panel-button {
            ${setOverview ? '' : 'box-shadow: none;'}
        }
        #panel${barEnhancedClass}.trilands:windowmax .panel-button {
            ${neonWMax ? '' : 'box-shadow: none;'}
        }
        #panel${barEnhancedClass}.trilands .panel-button:hover, #panel${barEnhancedClass}.trilands .panel-button:focus,
        #panel${barEnhancedClass}.trilands .panel-button:active, #panel${barEnhancedClass}.trilands .panel-button:checked {
            ${triMidNeonHoverStyle}
        }
        #panel${barEnhancedClass}.trilands:overview .panel-button:hover, #panel${barEnhancedClass}.trilands:overview .panel-button:focus,
        #panel${barEnhancedClass}.trilands:overview .panel-button:active, #panel${barEnhancedClass}.trilands:overview .panel-button:checked {
            ${setOverview ? '' : 'box-shadow: none;'}
        }
        #panel${barEnhancedClass}.trilands:windowmax .panel-button:hover, #panel${barEnhancedClass}.trilands:windowmax .panel-button:focus,
        #panel${barEnhancedClass}.trilands:windowmax .panel-button:active, #panel${barEnhancedClass}.trilands:windowmax .panel-button:checked {
            ${neonWMax ? '' : 'box-shadow: none;'}
        }
    ...
    // Candybar Styles
    stylesheet += `
        #panel${barEnhancedClass}.candybar .panel-button:candy1 {
            ${candyStyleArr[0]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy1:hover, #panel${barEnhancedClass}.candybar .panel-button:candy1:focus,
        #panel${barEnhancedClass}.candybar .panel-button:candy1:active, #panel${barEnhancedClass}.candybar .panel-button:candy1:checked {
            ${candyHighlightArr[0]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy2 {
            ${candyStyleArr[1]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy2:hover, #panel${barEnhancedClass}.candybar .panel-button:candy2:focus,
        #panel${barEnhancedClass}.candybar .panel-button:candy2:active, #panel${barEnhancedClass}.candybar .panel-button:candy2:checked {
            ${candyHighlightArr[1]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy3 {
            ${candyStyleArr[2]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy3:hover, #panel${barEnhancedClass}.candybar .panel-button:candy3:focus,
        #panel${barEnhancedClass}.candybar .panel-button:candy3:active, #panel${barEnhancedClass}.candybar .panel-button:candy3:checked {
            ${candyHighlightArr[2]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy4 {
            ${candyStyleArr[3]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy4:hover, #panel${barEnhancedClass}.candybar .panel-button:candy4:focus,
        #panel${barEnhancedClass}.candybar .panel-button:candy4:active, #panel${barEnhancedClass}.candybar .panel-button:candy4:checked {
            ${candyHighlightArr[3]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy5 {
            ${candyStyleArr[4]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy5:hover, #panel${barEnhancedClass}.candybar .panel-button:candy5:focus,
        #panel${barEnhancedClass}.candybar .panel-button:candy5:active, #panel${barEnhancedClass}.candybar .panel-button:candy5:checked {
            ${candyHighlightArr[4]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy6 {
            ${candyStyleArr[5]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy6:hover, #panel${barEnhancedClass}.candybar .panel-button:candy6:focus,
        #panel${barEnhancedClass}.candybar .panel-button:candy6:active, #panel${barEnhancedClass}.candybar .panel-button:candy6:checked {
            ${candyHighlightArr[5]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy7 {
            ${candyStyleArr[6]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy7:hover, #panel${barEnhancedClass}.candybar .panel-button:candy7:focus,
        #panel${barEnhancedClass}.candybar .panel-button:candy7:active, #panel${barEnhancedClass}.candybar .panel-button:candy7:checked {
            ${candyHighlightArr[6]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy8 {
            ${candyStyleArr[7]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy8:hover, #panel${barEnhancedClass}.candybar .panel-button:candy8:focus,
        #panel${barEnhancedClass}.candybar .panel-button:candy8:active, #panel${barEnhancedClass}.candybar .panel-button:candy8:checked {
            ${candyHighlightArr[7]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy9 {
            ${candyStyleArr[8]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy9:hover, #panel${barEnhancedClass}.candybar .panel-button:candy9:focus,
        #panel${barEnhancedClass}.candybar .panel-button:candy9:active, #panel${barEnhancedClass}.candybar .panel-button:candy9:checked {
            ${candyHighlightArr[8]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy10 {
            ${candyStyleArr[9]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy10:hover, #panel${barEnhancedClass}.candybar .panel-button:candy10:focus,
        #panel${barEnhancedClass}.candybar .panel-button:candy10:active, #panel${barEnhancedClass}.candybar .panel-button:candy10:checked {
            ${candyHighlightArr[9]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy11 {
            ${candyStyleArr[10]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy11:hover, #panel${barEnhancedClass}.candybar .panel-button:candy11:focus,
        #panel${barEnhancedClass}.candybar .panel-button:candy11:active, #panel${barEnhancedClass}.candybar .panel-button:candy11:checked {
            ${candyHighlightArr[10]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy12 {
            ${candyStyleArr[11]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy12:hover, #panel${barEnhancedClass}.candybar .panel-button:candy12:focus,
        #panel${barEnhancedClass}.candybar .panel-button:candy12:active, #panel${barEnhancedClass}.candybar .panel-button:candy12:checked {
            ${candyHighlightArr[11]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy13 {
            ${candyStyleArr[12]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy13:hover, #panel${barEnhancedClass}.candybar .panel-button:candy13:focus,
        #panel${barEnhancedClass}.candybar .panel-button:candy13:active, #panel${barEnhancedClass}.candybar .panel-button:candy13:checked {
            ${candyHighlightArr[12]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy14 {
            ${candyStyleArr[13]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy14:hover, #panel${barEnhancedClass}.candybar .panel-button:candy14:focus,
        #panel${barEnhancedClass}.candybar .panel-button:candy14:active, #panel${barEnhancedClass}.candybar .panel-button:candy14:checked {
            ${candyHighlightArr[13]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy15 {
            ${candyStyleArr[14]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy15:hover, #panel${barEnhancedClass}.candybar .panel-button:candy15:focus,
        #panel${barEnhancedClass}.candybar .panel-button:candy15:active, #panel${barEnhancedClass}.candybar .panel-button:candy15:checked {
            ${candyHighlightArr[14]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy16 {
            ${candyStyleArr[15]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy16:hover, #panel${barEnhancedClass}.candybar .panel-button:candy16:focus,
        #panel${barEnhancedClass}.candybar .panel-button:candy16:active, #panel${barEnhancedClass}.candybar .panel-button:candy16:checked {
            ${candyHighlightArr[15]}
        }
        #panel${barEnhancedClass}.candybar .panel-button:candy1.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:hover:candy1.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:checked:candy1.clock-display .clock,
        #panel${barEnhancedClass}.candybar .panel-button:candy2.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:hover:candy2.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:checked:candy2.clock-display .clock,
        #panel${barEnhancedClass}.candybar .panel-button:candy3.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:hover:candy3.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:checked:candy3.clock-display .clock,
        #panel${barEnhancedClass}.candybar .panel-button:candy4.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:hover:candy4.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:checked:candy4.clock-display .clock,
        #panel${barEnhancedClass}.candybar .panel-button:candy5.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:hover:candy5.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:checked:candy5.clock-display .clock,
        #panel${barEnhancedClass}.candybar .panel-button:candy6.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:hover:candy6.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:checked:candy6.clock-display .clock,
        #panel${barEnhancedClass}.candybar .panel-button:candy7.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:hover:candy7.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:checked:candy7.clock-display .clock,
        #panel${barEnhancedClass}.candybar .panel-button:candy8.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:hover:candy8.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:checked:candy8.clock-display .clock,
        #panel${barEnhancedClass}.candybar .panel-button:candy9.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:hover:candy9.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:checked:candy9.clock-display .clock,
        #panel${barEnhancedClass}.candybar .panel-button:candy10.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:hover:candy10.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:checked:candy10.clock-display .clock,
        #panel${barEnhancedClass}.candybar .panel-button:candy11.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:hover:candy11.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:checked:candy11.clock-display .clock,
        #panel${barEnhancedClass}.candybar .panel-button:candy12.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:hover:candy12.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:checked:candy12.clock-display .clock,
        #panel${barEnhancedClass}.candybar .panel-button:candy13.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:hover:candy13.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:checked:candy13.clock-display .clock,
        #panel${barEnhancedClass}.candybar .panel-button:candy14.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:hover:candy14.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:checked:candy14.clock-display .clock,
        #panel${barEnhancedClass}.candybar .panel-button:candy15.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:hover:candy15.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:checked:candy15.clock-display .clock,
        #panel${barEnhancedClass}.candybar .panel-button:candy16.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:hover:candy16.clock-display .clock, #panel${barEnhancedClass}.candybar .panel-button:checked:candy16.clock-display .clock {
            ${candyClockStyle}
        }

        #panel${barEnhancedClass}.candybar .workspace-dot {
            ${candyDotStyle}
        }
    `;
    ...
    if (applyAllShell) {
        ...
        /* Glassmorphic Widget Center - Bar Enhanced Dashboard */
        .bar-enhanced-dashboard-menu {
        ...
        .bar-enhanced-dashboard-subtitle {
        ...
        .bar-enhanced-dashboard-section-title {
        ...
        .bar-enhanced-dashboard-row {
            margin-bottom: 6px !important;
            spacing: 6px !important;
        }

        .bar-enhanced-dashboard-button {
        ...
        .bar-enhanced-dashboard-button:hover {
            background-color: rgba(255, 255, 255, 0.1) !important;
            border-color: rgba(255, 255, 255, 0.12) !important;
            color: #ffffff !important;
        }

        .bar-enhanced-dashboard-button:active {
        ...
        .bar-enhanced-dashboard-button.active:hover {
