...
export const DockSettings = GObject.registerClass({
    ...
    _init(extensionPreferences) {
        ...
        this._builder.add_from_file(`${extensionPreferences.path}/dash-to-dock/Settings.ui`);
        ...
        this.widget.connect('realize', () => {
            ...
            rootWindow.set_default_size(840, 680);
