...
export function autoApplyBGPalette(obar, requestMode) {
    ...
    let darkTheme = (requestMode == 'dark');
    ...
    if(theme == 'vanguard_gold') {
            if (darkTheme) {
                ...
                obar._settings.set_strv('vw-color', ['0', '0.7', '0.75']);
                obar._settings.set_strv('winbcolor', ['0', '0.7', '0.75']);
            } else {
                // --- ACTIVE LIGHT MODE VALUES ---
                obar._settings.set_strv('accent-color', ['0', '0.75', '0.75']);
                obar._settings.set_strv('bcolor', ['1.0', '1.0', '1.0']);
                obar._settings.set_strv('bgcolor', ['0.125', '0.125', '0.125']);
                obar._settings.set_strv('bgcolor-wmax', ['0.125', '0.125', '0.125']);
                obar._settings.set_strv('bgcolor2', ['0', '0.7', '0.75']);
                obar._settings.set_string('bguri', 'file:///home/mrvanguardia/.local/share/backgrounds/2026-04-08-22-21-17-astronaut-sunset-3840x2160-22922.jpg');
                obar._settings.set_strv('boxcolor', ['0.125', '0.125', '0.125']);
                obar._settings.set_strv('candy1', ['0', '0.61', '0.74']);
                obar._settings.set_strv('candy10', ['0.09', '0.19', '0.72']);
                obar._settings.set_strv('candy11', ['0.75', '0.49', '0.44']);
                obar._settings.set_strv('candy12', ['1', '0.92', '0.12']);
                ...
                obar._settings.set_strv('candy9', ['0.93', '0.20', '0.23']);
                obar._settings.set_strv('dbgcolor', ['0.125', '0.125', '0.125']);
                obar._settings.set_strv('fgcolor', ['1.0', '1.0', '1.0']);
                obar._settings.set_strv('hcolor', ['0', '0.7', '0.9']);
                obar._settings.set_strv('hscd-color', ['0', '0.7', '0.75']);
                obar._settings.set_strv('iscolor', ['0.125', '0.125', '0.125']);
                obar._settings.set_strv('mbcolor', ['1.0', '1.0', '1.0']);
                obar._settings.set_strv('mbgcolor', ['0.125', '0.125', '0.125']);
                obar._settings.set_strv('mfgcolor', ['1.0', '1.0', '1.0']);
                obar._settings.set_strv('mhcolor', ['0', '0.7', '0.9']);
                obar._settings.set_strv('mscolor', ['0', '0.7', '0.75']);
                obar._settings.set_strv('mshcolor', ['1.0', '1.0', '1.0']);
                obar._settings.set_strv('palette1', ['35', '34', '35']);
                obar._settings.set_strv('palette10', ['160', '160', '119']);
                obar._settings.set_strv('palette11', ['204', '169', '158']);
                obar._settings.set_strv('palette12', ['144', '144', '148']);
                ...
                obar._settings.set_strv('palette8', ['104', '102', '61']);
                obar._settings.set_strv('palette9', ['83', '89', '94']);
                obar._settings.set_strv('shcolor', ['0', '0', '0']);
                obar._settings.set_strv('smbgcolor', ['0.125', '0.125', '0.125']);
                obar._settings.set_strv('vw-color', ['0', '0.7', '0.75']);
                obar._settings.set_strv('winbcolor', ['0', '0.7', '0.75']);
            }
    
            // --- MODE PRESETS (DARK/LIGHT) ---
            obar._settings.set_strv('dark-accent-color', ['0.651', '0.576', '0.412']);
            obar._settings.set_strv('dark-bcolor', ['1.0', '1.0', '1.0']);
            obar._settings.set_strv('dark-bgcolor', ['1.000', '1.000', '1.000']);
            obar._settings.set_strv('dark-bgcolor-wmax', ['1.000', '1.000', '1.000']);
            obar._settings.set_strv('dark-bgcolor2', ['1.000', '1.000', '1.000']);
            ...
            obar._settings.set_strv('dark-dbgcolor', ['0.125', '0.125', '0.125']);
            obar._settings.set_strv('dark-fgcolor', ['0.651', '0.576', '0.412']);
            obar._settings.set_strv('dark-hcolor', ['0.604', '0.600', '0.588']);
            obar._settings.set_strv('dark-hscd-color', ['0', '0.7', '0.75']);
            obar._settings.set_strv('dark-iscolor', ['0.000', '0.000', '0.000']);
            obar._settings.set_strv('dark-mbcolor', ['0.604', '0.600', '0.588']);
            obar._settings.set_strv('dark-mbgcolor', ['0.000', '0.000', '0.000']);
            obar._settings.set_strv('dark-mfgcolor', ['0.651', '0.576', '0.412']);
            obar._settings.set_strv('dark-mhcolor', ['0.651', '0.576', '0.412']);
            obar._settings.set_strv('dark-mscolor', ['0.651', '0.576', '0.412']);
            obar._settings.set_strv('dark-mshcolor', ['0.651', '0.576', '0.412']);
            ...
            obar._settings.set_strv('dark-shcolor', ['1.000', '1.000', '1.000']);
            obar._settings.set_strv('dark-smbgcolor', ['0.482', '0.435', '0.337']);
            obar._settings.set_strv('dark-vw-color', ['0', '0.7', '0.75']);
            obar._settings.set_strv('dark-winbcolor', ['0', '0.7', '0.75']);
            ...
            obar._settings.set_double('candyalpha', 0.99);
            ...
            obar._settings.set_double('dbgalpha', 0.85);
            ...
            obar._settings.set_double('halpha', 0.34);
            ...
            obar._settings.set_double('hpad', 2.3);
            obar._settings.set_boolean('import-export', false);
            obar._settings.set_double('isalpha', 0.29);
            obar._settings.set_double('margin', 2.6);
            obar._settings.set_double('margin-wmax', 2.2);
            ...
            obar._settings.set_double('mhalpha', 0.3);
            ...
            obar._settings.set_double('msalpha', 0.85);
