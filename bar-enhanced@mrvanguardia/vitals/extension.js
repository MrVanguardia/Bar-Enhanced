...
export var VitalsMenuButton = GObject.registerClass({
    ...
    _init(extensionObject) {
        ...
        this._settings = extensionObject.getSettings('org.gnome.shell.extensions.vitals');
        ...
        this._sensorsIconPathPrefix = ['/vitals/icons/original/', '/vitals/icons/gnome/'];
    ...
    _updateTimerState() {
        ...
        if (this.mapped) {
            ...
            // Query immediately when mapped to get fresh data
            this._querySensors();
        }
    }
